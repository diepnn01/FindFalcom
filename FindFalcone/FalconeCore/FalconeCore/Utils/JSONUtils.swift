...
//                        let range = objectEncoded.index(objectEncoded.startIndex, offsetBy: 9)..<objectEncoded.index(objectEncoded.endIndex, offsetBy: -1)
//                        handledValue = String(objectEncoded[range])
//                        skip = false
//                    } else {
...
//                        handledValue = String(String(str)[range])
//                    }
//                } else {
//                    handledValue = "null"
//                }
...
//        }
    ...
    class func fromFile<T>(_ fileName: String) -> T {
